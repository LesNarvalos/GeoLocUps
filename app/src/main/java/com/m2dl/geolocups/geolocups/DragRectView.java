...
/**
 * Created by hichem on 13/03/2018.
 */
...
public class DragRectView extends View {
    ...
    private void init() {
        ...
        mRectPaint.setColor(getContext().getResources().getColor(android.R.color.black));
        mRectPaint.setStyle(Paint.Style.STROKE);
        mRectPaint.setStrokeWidth(5); // TODO: should take from resources

        mTextPaint = new TextPaint();
        mTextPaint.setColor(getContext().getResources().getColor(android.R.color.black));
